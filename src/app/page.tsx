  ...
  return (
    <div className="w-full py-16 lg:py-24 flex flex-col gap-28">
      ...
      <section id="projects" className="scroll-mt-24 pb-8">
        ...
        <div className="flex flex-col gap-6">
          {projects.map((project, idx) => (
            <Reveal key={project.name} delay={idx * 60}>
              <div className="border border-wood-line bg-card p-6 hover:border-brass hover:-translate-y-0.5 transition-all duration-300">
      ...
      <footer className="pb-16 font-mono text-xs text-muted">
        Designed &amp; built by {profile.name} · Press{" "}
